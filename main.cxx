...
int main()
{
    ...
    bigInt r(123123.4);
    cout<<"\n This is the r constructed with a double of 123123.4 (should be 123123): "<<r<<endl<<endl;
  
    cout<<"***COPY CONSTRUCTOR TEST***\n";
    bigInt s(r);
    cout<<"\n Now we are testing the copy constructor with a big int named s initialized to r (i.e. should be 123123): "<<s<<endl<<endl;
    
    cout<<"***OPERATOR EQUALS TEST***\n";
    cout<<"Now I'm declaring p and setting it equal to r (i.e. 123123): ";
    bigInt p;
    p=r;
    cout<<p<<endl<<endl;
    ...
    cout<<"*** OPERATOR - TEST ***\n";
    const char initialNumber3[13]= "240356970989";
    const char initialNumber4[13]= "103468903495";
    bigInt num1(initialNumber3);
    bigInt num2(initialNumber4);
    cout<<"\n HERE ARE THE TWO NUMBERS I AM SUBTRACTING : "<<num1<<" - "<<num2<<endl;
    bigInt num3 = num1 - num2;
    cout<<"HERE IS THE RESULT: " << num3 << endl;
